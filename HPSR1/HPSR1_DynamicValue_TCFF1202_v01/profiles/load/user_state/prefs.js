...
user_pref("LoadRunner.config.user_dir", "C:\\UISamples\\HPSR1\\HPSR1_DynamicValue_TCFF1202_v01");
...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1431529788);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 0);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1431529908);
...
user_pref("browser.slowStartup.averageTime", 4325);
...
user_pref("datareporting.healthreport.nextDataSubmissionTime", "1431616068130");
...
user_pref("datareporting.policy.firstRunTime", "1431529668129");
...
user_pref("idle.lastDailyNotification", 1431530012);
...
user_pref("toolkit.startup.last_success", 1431529667);
