...
user_pref("LoadRunner.config.user_dir", "C:\\Dev\\UI01_Tooltip_TCFF120");
...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1397395336);
user_pref("app.update.lastUpdateTime.background-update-timer", 1397395216);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 0);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1397394977);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1397395096);
...
user_pref("browser.slowStartup.averageTime", 1971);
...
user_pref("datareporting.healthreport.nextDataSubmissionTime", "1397481376170");
...
user_pref("datareporting.policy.firstRunTime", "1397394976170");
...
user_pref("toolkit.startup.last_success", 1397394975);
