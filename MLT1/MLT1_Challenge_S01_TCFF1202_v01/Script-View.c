...
Script_View_Init()
{
	/* Title: Demonstration TruClient script  Description: Correlation Challenge on MyLoadTest using TruClient scripting 
	   Protocol: TruClient Date: 2015.05.11 
	   Author: Wei Chien Yau 
	   Website: https://weichienyau.com Reviewed by Anil Mainali Fixed verification for the final step. */
